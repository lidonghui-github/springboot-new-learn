...
public class LogAspectHandler {
    ...
    public void pointCut() {
        System.out.println("pointCut在干活。。。。");
    }
    ...
    public void doBefore(JoinPoint joinPoint) {
        logger.info("====doBefore方法进入了====:"+new Date());
        ...
        logger.info("即将执行方法为: {}，属于{}包,参数为:{}", funcName, declaringTypeName, object);
    ...
    public void doAfterReturning2(JoinPoint joinPoint, Object result) {
     ...
     * @param ex        ex
     */
    @AfterThrowing(pointcut = "annotationCut()", throwing = "ex")
